...
try{
	String SQL = "SELECT * FROM product WHERE company = '주토피아'";
...
%>
		...
		<div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="nick_doll_04.png" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
			<!-- <img src="image/nick_doll_04.png" class="card-img-top" alt="..." width="300px" height="200px"> -->
            <div class="card-body">
